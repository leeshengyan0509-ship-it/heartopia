...
const translations = {
  ...
  '📅 最后更新：2026-05-16': '📅 Last updated: May 16, 2026',
  '✅ 有效': '✅ Active',
  '❌ 已过期': '❌ Expired',
  '🎁 金币 ×500 + 装饰家具 ×1': '🎁 500 Gold + 1 Decor Furniture',
  '🎁 爱好升级券 ×3': '🎁 3× Hobby Tokens',
  '🎁 新手礼包（金币 ×200 + 种子包 ×5）': '🎁 Starter Pack (200 Gold + 5 Seed Packs)',
  '🎁 限定装扮': '🎁 Limited Outfit',
  '复制': 'Copy',
  '已过期': 'Expired',
